<template>
  ...
  <form action="https://api.web3forms.com/submit" method="POST" id="form" class="needs-validation" novalidate>
    ...
    <div class="mb-5">
      <input type="text" :placeholder="translations.contactFormPlaceholderName" required
    ...
    <div class="mb-5">
      <label for="email_address" class="sr-only">{{ translations.contactFormPlaceholderEmail }}</label>
      <input id="email_address" type="email" :placeholder="translations.contactFormPlaceholderEmail" name="email"
        required
        class="w-full px-4 py-3 border-2 placeholder:text-gray-800 rounded-md outline-none focus:ring-4 border-gray-300 focus:border-gray-600 ring-gray-100" />

      <div class="empty-feedback text-red-400 text-sm mt-1">
        {{ translations.contactFormErrorEmail }}
      </div>
    ...
    <div class="mb-3">
      <textarea name="message" required :placeholder="translations.contactFormPlaceholderMessage"
